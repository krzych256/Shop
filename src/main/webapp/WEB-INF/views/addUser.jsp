...
<div class="container">
	<div class="row col-md-offset-3 col-md-6 col-md-offset-3">		
		<form:form class="form-horizontal" action="${pageContext.request.contextPath}/admin/addUser" method="post" commandName="users">
			<fieldset>
				<legend class="">Dodaj użytkownika</legend>
